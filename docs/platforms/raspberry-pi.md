...
??? question "Container fails to start with exec format error"
...
??? question "Build fails with CGO errors"
...
??? question "High CPU usage at idle"
...
??? question "mDNS discovery not working"
...
??? question "Slow SD card performance"
...
- [Quick Start Guide](../getting-started/quick-start.md) - Configure Nekzus
- [Docker Compose Guide](../guides/docker-compose.md) - Advanced Docker setups
- [Discovery Configuration](../features/discovery.md) - Set up service discovery
