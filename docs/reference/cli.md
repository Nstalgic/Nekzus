...
For detailed configuration file options, see the [Configuration Reference](configuration.md).
...
??? question "Server fails to start with 'failed to load TLS certificate'"
...
??? question "Health check returns unhealthy"
...
??? question "Configuration validation fails"
...
??? question "Environment variables not being applied"
...
- [Configuration Reference](configuration.md) - Detailed configuration file options
- [Installation Guide](../getting-started/installation.md) - Installation methods
- [Docker Compose Guide](../guides/docker-compose.md) - Docker deployment patterns
