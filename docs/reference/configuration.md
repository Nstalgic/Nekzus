...
This is the complete configuration reference for Nekzus. For a quick introduction to configuration, see the [Getting Started Guide](../getting-started/configuration.md).
...
??? info "Kubernetes Auto-Discovery"
