...
=== "Keyboard Shortcut"
    ...
    Press ++ctrl+k++ (or ++cmd+k++ on macOS) to open the theme switcher modal.
...
| Shortcut | Action |
|----------|--------|
| ++ctrl+k++ / ++cmd+k++ | Open theme switcher |
...
??? question "WebSocket disconnecting frequently"
...
??? question "Theme not applying correctly"
...
??? question "Real-time updates not working"
...
-   :material-magnify:{ .lg .middle } **Discovery Features**
    ...
    [:octicons-arrow-right-24: Discovery](discovery.md)
...
-   :material-toolbox:{ .lg .middle } **Toolbox**
    ...
    [:octicons-arrow-right-24: Toolbox](toolbox.md)
