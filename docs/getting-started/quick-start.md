...
??? question "Docker discovery not finding containers"
...
??? question "Proxy returns 502 Bad Gateway"
...
??? question "Cannot access dashboard from other devices"
...
-   :material-docker:{ .lg .middle } **Docker Compose Guide**

    ---

    Production-ready Docker Compose setup with Caddy for TLS termination.

    [:octicons-arrow-right-24: Docker Compose](../guides/docker-compose.md)

-   :material-magnify:{ .lg .middle } **Discovery Features**

    ---

    Deep dive into Docker, Kubernetes, and mDNS service discovery.

    [:octicons-arrow-right-24: Discovery](../features/discovery.md)

-   :material-toolbox:{ .lg .middle } **Toolbox**

    ---

    One-click deployment of popular services from the built-in catalog.

    [:octicons-arrow-right-24: Toolbox](../features/toolbox.md)
...
-   :material-server:{ .lg .middle } **Platform Guides**
