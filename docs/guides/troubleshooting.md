...
??? question "Container exits immediately after starting"
...
??? question "Container keeps restarting in a loop"
...
??? question "Error: bind: address already in use"
...
??? question "Permission denied when accessing files or Docker socket"
...
??? question "Docker discovery shows 'Docker socket unavailable'"
...
??? question "Containers are running but not appearing in discovery"
...
??? question "Container discovered but HTTP probe fails"
...
??? question "mDNS discovery not finding any services"
...
??? question "Kubernetes discovery shows 'failed to create Kubernetes config'"
...
??? question "Services discovered but cannot be accessed"
...
??? question "Error: 'TOKEN_EXPIRED' (Code 1001)"
...
??? question "Error: 'TOKEN_INVALID' (Code 1002)"
...
??? question "Error: 'DEVICE_REVOKED' (Code 1004)"
...
??? question "QR code scanning works but pairing fails"
...
??? question "Mobile app cannot reach Nexus server"
...
??? question "API key returns 401 Unauthorized"
...
??? question "Request rejected even from local network"
...
??? question "WebSocket upgrade fails with 'WebSocket hijacking not supported'"
...
??? question "WebSocket connects but data not flowing"
...
??? question "Error: 'Gateway Timeout' (504)"
...
??? question "Error: 'Bad Gateway' (502)"
...
??? question "Error: 'x509: certificate signed by unknown authority'"
...
??? question "Mobile app rejects self-signed certificate"
...
??? question "Application returns 404 for assets or API calls"
...
??? question "Error: 'database disk image is malformed'"
...
??? question "Error: 'migration failed' on startup"
...
??? question "Container using excessive memory"
...
??? question "API requests taking longer than expected"
...
??? question "Too many connections to upstream services"
...
??? question "How to enable verbose logging"
...
??? question "How to effectively read and filter logs"
...
??? question "Understanding common log messages"
