...
<TabItem value="fedora-rhel" label="Fedora/RHEL">
...
<details>
<summary>Permission denied on data volume</summary>
...
- [Quick Start Guide](quick-start) - Get started with basic configuration
- [Configuration Reference](configuration) - Detailed configuration options
- [Platform Guides](../platforms/) - Platform-specific instructions
- [Docker Compose Guide](../guides/docker-compose) - Advanced Docker Compose setups
