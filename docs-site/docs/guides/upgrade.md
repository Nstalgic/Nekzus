...
<TabItem value="binary-deployment" label="Binary Deployment">
...
<TabItem value="kubernetes-deployment" label="Kubernetes Deployment">
...
<details>
<summary>Deprecated: toolbox.catalog_path</summary>
...
See the [Toolbox documentation](../features/toolbox) for migration details.
...
<Tabs>
<TabItem value="v0-11-0-scripts" label="v0.11.0+ Scripts">
...
<TabItem value="v0-10-0-cookie-persistence" label="v0.10.0+ Cookie Persistence">
...
<TabItem value="v0-9-0-auto-jwt-secret" label="v0.9.0+ Auto JWT Secret">
...
<TabItem value="v0-8-0-federation" label="v0.8.0+ Federation">
...
<Tabs>
<TabItem value="using-previous-image-tag" label="Using Previous Image Tag">
...
<TabItem value="using-backup" label="Using Backup">
