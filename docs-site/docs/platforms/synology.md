...
<Tabs>
<TabItem value="using-container-manager-gui" label="Using Container Manager GUI">
...
<TabItem value="using-docker-compose-project" label="Using Docker Compose Project">
...
<Tabs>
<TabItem value="container-manager-gui" label="Container Manager GUI">
...
<details>
<summary>No containers discovered</summary>
...
<details>
<summary>Socket permission denied</summary>
...
<details>
<summary>WebSocket connections fail</summary>
...
<details>
<summary>mDNS discovery not finding services</summary>
...
<details>
<summary>Database locked error</summary>
...
<details>
<summary>Database corruption</summary>
...
- [Quick Start Guide](../getting-started/quick-start) - Configure your first services
- [Configuration Reference](../reference/configuration) - Detailed configuration options
- [Toolbox Guide](../features/toolbox) - Deploy services with one click
